...
"[project]/src/app/agency-requests/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgencyRequests() {
    ...
    const [allHotels, setAllHotels] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const { reload: reloadNotifications } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useNotifications"])(userId);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadData = async ()=>{
            try {
                ...
                setUserId(userId);
                const orgResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("id").eq("created_by", userId).eq("role", "agency").maybeSingle();
                if (!orgResponse.data) {
                ...
                const pendingResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").select("id, status, hotel_id").eq("agency_id", orgResponse.data.id).eq("status", "pending").eq("created_by_role", "hotel"); // ← SOLO las que envían los hoteles
                if (pendingResponse.data) {
                    const hotelIds = pendingResponse.data.map((r)=>r.hotel_id);
                    const hotelNamesResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("id, name").in("id", hotelIds);
                    const hotelNameMap = {};
                    (hotelNamesResponse.data || []).forEach((hotel)=>{
                        hotelNameMap[hotel.id] = hotel.name;
                    });
                    const formattedPending = pendingResponse.data.map((r)=>({
                            id: r.id,
                ...
                const associationsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").select("id, status, hotel_id").eq("agency_id", orgResponse.data.id).eq("status", "approved");
                if (associationsResponse.data) {
                    ...
                    const formattedAssociations = associationsResponse.data.map((r)=>({
                            id: r.id,
                            hotel_name: hotelNameMap[r.hotel_id] || "Hotel desconocido",
                            status: r.status
                        }));
                ...
                const allHotelsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("id, name").eq("role", "hotel");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const filtered = allHotels.filter((hotel)=>hotel.name.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    const handleSendRequest = async ()=>{
        ...
        try {
            ...
            const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").select("id, status").eq("agency_id", orgResponse.data.id).eq("hotel_id", selectedHotel.id).not("status", "eq", "rejected");
            ...
            // Crear la solicitud
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").insert({
            ...
            const { data: hotelData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("created_by").eq("id", selectedHotel.id).single();
            if (hotelData) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendInvitationReceivedNotification"])(hotelData.created_by, selectedHotel.id, orgResponse.data.name // nombre de la agencia
                );
            }
            // Limpiar formulario
    ...
    const handleRespond = async (requestId, status)=>{
        try {
            ...
            const { data: requestData, error: requestDataError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").select("hotel_id, agency_id").eq("id", requestId).single();
            if (requestDataError) {
            ...
            const { data: notificationData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("notifications").select("id").eq("user_id", currentUserId).eq("type", "invitation_received").eq("organization_id", requestData.hotel_id).order("created_at", {
                ascending: false
            }).limit(1);
            // Actualizar el estado de la solicitud
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").update({
                status
            }).eq("id", requestId);
            if (error) throw error;
            // ✅ ENVIAR NOTIFICACIÓN AL HOTEL (que envió la invitación)
            const orgResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("id, name").eq("created_by", currentUserId).maybeSingle();
            if (orgResponse.data) {
                // Obtener el user_id del hotel
                const { data: hotelData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("created_by, name").eq("id", requestData.hotel_id).single();
                if (hotelData) {
                    if (status === "approved") {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendInvitationAcceptedNotification"])(hotelData.created_by, requestData.hotel_id, orgResponse.data.name // nombre de la agencia
                        );
                    } else if (status === "rejected") {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendInvitationRejectedNotification"])(hotelData.created_by, requestData.hotel_id, orgResponse.data.name // nombre de la agencia
                        );
                    }
                }
            }
            ...
            const orgResponseReload = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("organizations").select("id").eq("created_by", userIdReload).maybeSingle();
            if (!orgResponseReload.data) return;
            // Recargar invitaciones pendientes (SOLO las de hoteles)
            const { data: pending } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").select("id, status, hotel_id").eq("agency_id", orgResponseReload.data.id).eq("status", "pending").eq("created_by_role", "hotel");
            if (pending) {
            ...
            if (status === "approved") {
                const { data: associations } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("agency_hotel_access").select("id, status, hotel_id").eq("agency_id", orgResponseReload.data.id).eq("status", "approved");
                if (associations) {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                showDropdown && filteredHotels.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ref: dropdownRef,
                                                ...
                                                showDropdown && filteredHotels.length === 0 && searchTerm.trim() !== "" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ref: dropdownRef,
                                                    className: "jsx-bc8c81cc93ef4b4a" + " " + "absolute top-full left-0 right-0 bg-white border border-gray-300 rounded-lg mt-2 max-h-60 overflow-y-auto shadow-lg z-50",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        selectedHotel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5954c08d._.js.map